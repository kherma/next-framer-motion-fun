  ...
  return (
    <div className="flex justify-center items-center w-full h-96 min-h-[24rem] sm:h-[35rem] xl:h-full">
      <motion.button
        ...
        className="relative w-56 h-28 sm:scale-150"
      >
        ...
        >
          <p className="py-2 px-4 text-[0.5rem] font-black text-slate-200">
            ...
            molestiae nulla ea ad asperiores eveniet, perferendis eaque!
            Adipisci ea dolorem veritatis, voluptates id reiciendis sapiente
            corporis, in assumenda fuga tempora numquam praesentium quod saepe
            quo ut magni minus fugit aut enim aliquam maiores error, ullam
            perferendis. Nesciunt ipsa porro incidunt quasi saepe maiores
            reiciendis commodi minima enim nihil?
          </p>
        </motion.div>
